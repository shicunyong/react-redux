            ...
            <div className="page-test">
                ...
                <div className="box">
                    ...
                    <div className="list">
                        ...
                        <p>
                            <Button type="primary"
                                    onClick={() => this.props.actions.onTestAdd(this.props.num)}>通过action改变数据num</Button>&nbsp;
                            <br/>
                    ...
                    <div className="list">
                        ...
                        <div className="p-box">
                            <Button type="primary"
                                    onClick={() => this.onAjaxClick()}>ajax请求测试(使用的request库)</Button><br/>
                            数据：
                            <ul>
                                {
                                    this.state.mokeAjax.map((item, index) => <li
                                        key={index}>{`id: ${item.id}, email: ${item.email}`}</li>)
                                }
                            </ul>
                        </div>
                        <div className="p-box">
                            <Button type="primary"
                                    onClick={() => this.onFetchClick()}>fetch请求测试(使用的axios库)</Button><br/>
                            数据：
                            <ul>
                                {
                                    this.state.mokeFetch.map((item, index) => <li
                                        key={index}>{`id: ${item.id}, email: ${item.email}`}</li>)
                                }
                            </ul>
                        </div>
